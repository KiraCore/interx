...
func (x *QueryAllowancesRequest) GetPagination() *query.PageRequest {
	if x != nil {
		return x.Pagination
	}
	return nil
...
func (x *QueryAllowancesResponse) GetPagination() *query.PageResponse {
	if x != nil {
		return x.Pagination
	}
	return nil
...
func (x *QueryAllowancesByGranterRequest) GetPagination() *query.PageRequest {
	if x != nil {
		return x.Pagination
	}
	return nil
...
func (x *QueryAllowancesByGranterResponse) GetPagination() *query.PageResponse {
	if x != nil {
		return x.Pagination
	}
	return nil
...
var file_cosmos_feegrant_v1beta1_query_proto_rawDesc = []byte{
	...
	0x66, 0x65, 0x65, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
